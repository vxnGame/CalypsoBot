...
module.exports = class SayCommand extends Command {
    ...
    `);
		...
		if (!channel.permissionsFor(message.guild.me).has(['SEND_MESSAGES'])) {return this.sendErrorMessage(message, 0, 'I do not have permission to send messages in the provided channel');}

		if (!channel.permissionsFor(message.member).has(['SEND_MESSAGES'])) {return this.sendErrorMessage(message, 0, 'You do not have permission to send messages in the provided channel');}
