...
module.exports = class SlowmodeCommand extends Command {
	...
	async run(message, args) {
		...
		if (!channel.permissionsFor(message.guild.me).has(['MANAGE_CHANNELS'])) {return this.sendErrorMessage(message, 0, 'I do not have permission to manage the provided channel');}
