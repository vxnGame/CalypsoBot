...
module.exports = class LeaveGuildCommand extends Command {
	constructor(client) {
		super(client, {
			...
			description: 'Forces vxn\'s minions to leave the specified server.',
	...
	async run(message, args) {
		...
		if (!rgx.test(guildId)) {return this.sendErrorMessage(message, 0, 'Please provide a valid server ID');}
